...
export default function Page() {
  ...
  const handleMovieClick = async (movie) => {
    try {
      ...
      // If we don't have an ID, search by title first
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <Library type="Popular" onMovieClick={handleMovieClick} />
      <Library type="Top Rated" onMovieClick={handleMovieClick} />
      <Library type="New Release" onMovieClick={handleMovieClick} />
      <Library type="Upcoming" onMovieClick={handleMovieClick} />

      {/* Genre sections */}
      {genres.map((genre) => (
        <Genre key={genre} genre={genre} onMovieClick={handleMovieClick} />
      ))}
