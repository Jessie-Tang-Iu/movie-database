  ...
  return (
    <nav className="flex justify-between items-center px-4 py-3 bg-neutral-900 text-white shadow-md">
      ...
      <div className="flex space-x-6 text-sm font-semibold">
        <Link href="/movies" className="hover:text-cyan-400 transition-colors">Movies</Link>
        <Link href="/tv" className="hover:text-cyan-400 transition-colors">TV Shows</Link>
      </div>
